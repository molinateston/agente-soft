...
1. aula-webinar-AAA-gravada.md (verbatim real da aula do webinar do dono, ~1h49 com transcricao literal). Path default: ~/lean-bridge/brain/conteudo/aula-webinar-AAA-gravada.md

2. NARRATIVA-CANONICA.md (a fonte da verdade da tese-mae). Path: ~/lean-bridge/brain/NARRATIVA-CANONICA.md
...
Para cada afirmacao grande da copy, extrai 2-3 termos-chave (nome de mecanismo, numero, prova, historia) e grepa nas fontes:
  ...
  grep -i -l "TERMO" ~/lean-bridge/brain/**/*.md

Se nenhum arquivo retorna, e chute. Reprova.

## Provas canonicas validadas do dono (exemplo, nao copia)
...
Nao use estes numeros pra cliente que nao e o dono. Cada dono tem os seus. Estao aqui so como MODELO da estrutura "numero + contexto + peso".
