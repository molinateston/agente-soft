...
feedback estruturado em 4 filtros na ordem fixa. Skill
...
- soft-webinar-plano (aula + oferta + escalada + pitch)
- soft-webinar-paginas (cadastro, obrigado, checkout)
- soft-webinar-mensagens (WhatsApp + e-mail)
...
- soft-voz (peca canonica sob voz do dono)
...
morreu). Depois Anti-IA (o cheiro de robo). Depois Verbatim
(o lastro na fonte).
...
molde "nao e sobre X, e sobre Y".

COUNT (warn se excede): literalmente (1x/peca),
absolutamente (1x), verdadeiro/a (1x), estrutura "Nao e X. E
Y." em serie (2x).
...
escapam falso-positivo (fala real do dono com "nao e sobre X"
com sujeito+verbo): o proprio codigo em scripts/lint_copy.py
comentado.
...
1. aula-webinar-AAA-gravada.md (verbatim real do dono na
   ...
   ~/lean-bridge/brain/conteudo/aula-webinar-AAA-gravada.md
   (ou o path equivalente no cliente)
2. NARRATIVA-CANONICA.md (a fonte da verdade da tese-mae).
   Path: ~/lean-bridge/brain/NARRATIVA-CANONICA.md
...
regua) e aplica os filtros 1 (CUB), 2 (Estrutura-mae) e 4
(Verbatim).
...
Todas as pecas passam nos 4 filtros. Estes sao os pesos
...
1) ZERO DEFAULT DO LEO. Naming do produto do dono (Operacao
...
- ~/lean-bridge/brain/NARRATIVA-CANONICA.md
  (fonte da tese-mae)

Este SKILL.md sintetiza. Detalhe operacional dos filtros em
references/_regua-cub.md, _estrutura-mae.md, _verbatim-fontes.md.
