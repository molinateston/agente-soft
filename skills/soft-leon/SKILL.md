...
- **2 Pilares + 1 Motor:** Posicionamento (ocupa o lugar que ninguém divide) · Funil Minimalista (faz o cliente certo chegar filtrado) · Agente do dono (carrega o operacional, é você).
...
Esta skill é COMPARTILHADA (LEON do dono + LEON de todo cliente da frota). Toda pergunta é ABERTA, ZERO default do dono (mesma regra da soft-webinar-plano cravada 23/07 07h30): naming, produto, avatar, voz , tudo vem do usuário que está falando com o LEON, nunca de fábrica.
