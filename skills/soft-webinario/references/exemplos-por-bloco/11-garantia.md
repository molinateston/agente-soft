...
> "And when you sign up, here's my guarantee to you. I know this to be true that if you run a webinar in the next 30 days following my formula, just even a tiny bit of my formula and you don't see a massive improvement that's worth a significant amount more than your investment today for $14.97, then here's what you do. Just contact our supportcrush.com. Just write us an email and give us a link to your webinar that you ran and tell us your results. That's it. Then we'll say say, \"I want my money back.\" We say, \"Okay, no problem.\" Promptly and quietly, we'll return every penny of your investment back to you. We only want to keep you as a customer if you make far far far more in a very short period of time with a very short amount of effort, far more in revenue than what you invest in here today. That's my guarantee to you. There is no risk. There's only reward."

E no ensino (ele dá a doutrina do bloco dentro do próprio webinar):

> "powerful guarantees because a right guarantee can do more for your webinars than anything else can do."

**O que ele fez:** (1) garantia condicional de resultado (30 dias, "run a webinar following my formula") - não é satisfação genérica, é aposta no método; (2) condição levíssima ("just even a tiny bit of my formula"); (3) processo de reembolso encenado passo a passo, incluindo o diálogo ("We say, 'Okay, no problem.'"); (4) promessa de dignidade ("Promptly and quietly" - sem constrangimento); (5) reframe de filtro ("We only want to keep you as a customer if you make far more") que transforma a garantia em declaração de confiança; (6) fechamento em aforismo ("There is no risk. There's only reward.").

**Por que funciona:** encenar o reembolso elimina o medo real (a fricção e a vergonha de pedir), não só o risco financeiro - que em US$14,97 é irrelevante. A garantia aqui trabalha menos o bolso e mais a identidade: "esse vendedor tem tanta certeza que paga pra me ver tentar".

**O que é decalcável vs do nicho:** decalcável: condicionar a garantia à APLICAÇÃO (com condição leve e verificável), encenar o processo de reembolso com dignidade, o reframe de filtro. Do nicho: o prazo de 30 dias amarrado a "rodar um webinar" - a unidade de aplicação muda por nicho (rodar a oferta, atender o cliente, executar o funil).
...
> "When you invest, know this. Your investment is protected twice. Here's what I mean. First of all, we have the standard any reason or no reason at all. If you want your money back in the first 30 days, you got it. No questions asked. Don't even give me a reason. I only want you as a customer if you want to be my customer. […] But I am so confident in the power of product e-class and what it can do for you that I'm going to go the extra mile for you and I'm going to offer you the double your money back guarantee. And here's how this one goes. I share with you every product creation secret that I have. All you have to do is follow one of them and you get 60 days to implement it. And in those 60 days, if you follow just one of these methods and you don't double your investment, then I will give you double your investment back."

O porquê (lógica atuarial declarada):

> "And you say, Jason, how can you do that? I know the numbers. I know for the amount of people where this fails is so minuscule versus the amount of people where this succeeds for is so absolutely overwhelmingly positive that if I got to pay for a small number of people who happen to be the most unluckiest sobs in the world, I will because that will make me also have more success stories."

O desafio aberto (anti-ceticismo):

> "Here's the deal. Challenge me on this one. I've had more than one customer say, \"Jason, I just signed up for product E-Class simply so I could take advantage of you and your double your money back guarantee.\" […] And I say, \"Great. How did it play out for you?\" And almost to the person, they say, \"Oh, yeah. I didn't need your guarantee because I made more than twice my money back.\""

A frase-síntese:

> "what I discovered about this business is if I remove every possibility for you to fail, then what is left? Only success."

As condições (no Q&A, com a metáfora do cheque):

> "You got to make at least one sale. It could be you. It could be even your mother, your father, your brother, your sister, your cousin, your best friend. I don't care. You got to make one sale. […] It's like I'm giving you a check, but you got to go to the bank and cash it. Going to the bank is actually following the program, right?"

**O que ele fez:** (1) garantia em dupla camada: incondicional 30 dias ("no questions asked") + condicional "double your money back" em 60 dias - reversão de risco vira INVERSÃO de risco; (2) reason-why atuarial explícita ("I know the numbers"); (3) prova social da própria garantia (clientes que entraram para explorá-la e não precisaram); (4) condições desenhadas para forçar implementação (criar, publicar, fazer 1 venda, documentar) - a garantia é um mecanismo de sucesso disfarçado; (5) metáfora do cheque que precisa ser descontado.

**Por que funciona:** "se você fizer o básico, ou ganha dinheiro ou eu te pago o dobro" reposiciona a compra como aposta sem lado perdedor - e as condições da garantia são, na prática, o plano de ação que gera o resultado que elimina o reembolso. A camada incondicional cobre o cético raso; a camada dobrada cala o cético profundo.

**O que é decalcável vs do nicho:** decalcável: a arquitetura em duas camadas (incondicional curta + condicional de resultado), o reason-why atuarial, condições que são o próprio protocolo de implementação. Do nicho: "fazer 1 venda" como condição - cada nicho tem sua unidade mínima de implementação verificável.

---

### Webinar o dono A (pele Soft aplicada: nutrição / Vítor Abrão / MDI) - R$997→797; garantia escalonada em dois estágios com consultoria no meio
...
## Padrões transversais (checklist - o que os 3 que têm o bloco fazem)

- [ ] **Garantia condicional de RESULTADO, não satisfação genérica.** A condição é sempre "aplique o método" (rode 1 webinar / siga 1 método e faça 1 venda / 90 dias preenchendo o app). Quem garante resultado está apostando no mecanismo - e diz isso.
...
- [ ] **Escalonamento que embute valor** (consultoria de R$3.000 antes do reembolso - o dono A; dupla camada 30/60 dias - Fladlien #2). Cada degrau da garantia é mais uma âncora.
...
- **Condição burocrática que humilha.** As condições dos campeões são leves e dignas ("even a tiny bit of my formula"; "uma venda, pode ser pra sua mãe") - garantia com letra miúda hostil destrói a confiança que ela existe pra criar.
...
- **13M (a escola de gestão):** nenhuma menção. O risco é tratado por outras vias: preço reduzido ao ridículo ("cabe no orçamento de qualquer um"), 12 meses de acesso ("inicia quando puder") e suporte de plantão. Fecha no impulso + preço baixo percebido.
