...
O futuro pintado antes da tese (future pacing em 5 cenários + 5 de carreira):

> "Imagina você ter um domínio total do seu tempo equilibrando carreira e vida pessoal de forma harmoniosa. quem aqui tem problema com gestão de tempo coloca aqui para eu saber […] Imagina você liderar uma equipe engajada, produtiva e principalmente autônoma […] Imagine você ter metas superadas com frequência n se posicionando como um líder de referência na sua área"
...
> "já grava isso: você tem que gostar de problemas tá, tem que gostar de problemas. por que que você tem que gostar de problema? porque problema é igual oportunidade, problema significa oportunidade. mas problema é oportunidade para quem? para quem tá sofrendo com o problema não, problema é uma oportunidade para quem sabe resolver problemas, e é isso que eu quero ensinar vocês aqui, a serem resolvedores de problemas de gestão"
...
**O que é decalcável vs do nicho:** decalcável: future pacing → frase única grifada → reframe de culpa → janela com número → equação. Do nicho: a equação carreira-CLT (resolver problema da empresa → salário) e o slogan "gestor do futuro" (da escola de gestão) - o equivalente Soft tem que ser equação de dono de negócio, na voz do dono.
...
> "Se você quiser esquecer tudo o que eu falei até agora, e lembrar de uma única coisa, lembra disso aqui. A chave para você crescer e se manter relevante como líder no mercado, crescer na sua carreira, é aprender como resolver os problemas das empresas, aprender como resolver os problemas do mercado."
...
> "Inclusive, eu trouxe aqui uma frase do Einstein. Nem sei se é realmente do Einstein, porque sempre tem aquelas frases, se procura na internet e fala que é do Einstein. […] Ele diz que a definição de insanidade é continuar fazendo as mesmas coisas e esperar resultados diferentes. Quando você olha para esse gráfico louco aqui do mundo, é mais insano ainda achar que é possível fazer gestão hoje em dia da mesma forma que a gente fazia no século passado"
...
**Por que funciona:** o dominó é "quem resolve problemas das empresas cresce; gestão ágil é COMO se resolve os problemas da era VUCA" - aceitou isso, o curso é a única conclusão. As manchetes terceirizam a prova: não é o vendedor dizendo que o mercado quer, é a Globo. E o disclaimer do Einstein compra credibilidade para o resto. Nota da análise a escola de gestão (exemplos-vivos): este bloco é montado em 6 movimentos distribuídos - mídia, causa-raiz impessoal (gráfico de Fogel), inimigo nomeado (gestor do passado), equação pessoal, ampliação de escopo ("muito mais que Scrum e Kanban" - a "visão de floresta", mecanismo da escola de gestão), janela ("em terra de cego quem tem olho é rei").

**O que é decalcável vs do nicho:** decalcável: a anatomia em movimentos + "se for lembrar de uma coisa só" + prova por manchete + binarização. Do nicho: VUCA, "visão de floresta" (da escola de gestão) e o frame de obsolescência profissional CLT.

---

### 5 Níveis de Planejamento (Denison Vieira, CEO da escola de gestão) - mesma máquina/mesmo script-base do 13M; Gestão Ágil 2.0 de R$3.000 → R$1.697 (R$165/mês)
...
**O que ele fez:** (1) big domino explícito ("basta você aprender a resolver os problemas das empresas" → todos os sonhos caem); (2) reframe de crença (problema = ouro, não sofrimento); (3) janela quantificada com hedging tático; (4) slogan repetível ("gestor do futuro", da escola de gestão) que vira identidade aspiracional usada o webinar inteiro; (5) correção da própria frase para fechar a janela ("é a gestão do futuro, mas é aquele futuro que já começou" - urgência sem timer); (6) prova por interesse próprio (o crescimento da escola de gestão citado como termômetro da onda).

**Por que funciona:** a crença única é uma só: "se você souber resolver os problemas de gestão das empresas, tudo o mais (salário, reconhecimento, liberdade) é consequência automática". Aceitou, o curso vira o único passo lógico - todo o resto do webinar só empilha evidência nesse dominó. ACHADO DE CORPUS: este bloco é quase palavra-por-palavra idêntico ao do 13M - duas gravações, mesma sequência, mesmas frases. O Big Domino da máquina da escola de gestão é ativo fixo ensaiado, não improviso de palco.

**O que é decalcável vs do nicho:** decalcável: a constatação de que a frase-dominó deve ser FIXA e repetida idêntica em toda edição do perpétuo. Do nicho: tudo que é da escola de gestão (gestor do futuro, equação carreira) - extrair o esqueleto, nunca as palavras.
...
A crença única, formulada já na abertura:

> "Como eu já falei, eu trabalho remotamente do Brasil para os Estados Unidos. Se eu posso, você também pode. Já tem 4 anos que eu faço isso. E eu vou te dar hoje um passo a passo com estratégias para você aplicar real oficial, gente, para você realmente colocar em prática. Você vê que não só é possível como é viável e a realidade já de muitas pessoas. […] E detalhe, tá? Sem precisar falar inglês fluente e também sem precisar validar diploma, porque tem esse mito por aí, né?"

A nova oportunidade legitimada pelos grandes (não é invenção dela):

> "Eu não tô inventando a roda, eu não sou a primeira a fazer isso no mundo. Se você não sabe, escritórios grandes brasileiros, eles fazem isso há décadas. Estúdio Artu Casas, Jacobs Arquitetura, Tripitque Arquitetura e vários outros escritórios, eles fazem isso há décadas. vai dizer que você nunca ouviu falar de projetos grandes de brasileiros em outros países. Eles fazem, eles só não nunca te contaram como você também pode fazer. Até o dia que eu me atentei para isso, eu falei: \"Gente, se alguém faz, eu também posso fazer\". Só que o problema é que ninguém ensina, né?"

A declaração de promessa de prova:

> "Hoje eu vou te apresentar uma proposta única que vai mudar a sua realidade, eu tenho certeza. Tá preparado?"
...
E o fecho do dominó (dito no meio do case da Verônica):
...
**O que é decalcável vs do nicho:** decalcável: embutir a negação das duas objeções-mãe DENTRO da declaração da crença; legitimar a oportunidade por precedente de quem o avatar já admira; ritualizar a quebra do mito ("quebrado, tirou da cabeça"). Do nicho: diploma/inglês/escritórios de arquitetura - no Soft o precedente de elite tem que ser do universo do avatar do perfil.

---

### Webinar do dono - A (pele Soft aplicada: nutrição / Vítor Abrão / MDI) - evergreen, MDI de R$5.638 ancorado → R$997 → 12x R$79,78, garantia em dobro

**Trecho literal:**

> "para você conseguir ter um resultado, PR você conseguir ter o teu emagrecimento, o teu ganho de massa muscular, os dois acontecendo ao mesmo tempo, você precisa de uma coisa principal chamada adesão. o que que é adesão: é a capacidade que você tem de seguir aquilo que tá sendo planejado por bastante tempo, simples assim"

> "qualquer resultado que você alcança de uma forma, Ele só pode ser mantido daquela mesma forma. ou seja, se você alcançou o resultado com uma dieta extremamente restrita e burra, Você só vai vai conseguir manter aquele resultado com aquela mesma dieta restrita e burra"

> "você pode emagrecer comendo pão todo dia, você pode engordar sem comer pão nunca mais. é isso que você não consegue entender, é isso que ninguém nunca te explicou"

> "insanidade É continuar fazendo sempre a mesma coisa e esperar resultados diferentes. não dá para você sair daqui depois de ver tudo que eu tô te falando e continuar tentando da mesma maneira que você tentou a vida inteira"
...
### Webinar C (corpus o dono) - "Resina Anterior / Método One 2.0" (voz que se identifica como Bruno, dentista) - odonto, R$12.000 ancorado → R$3.000 (bio) → R$1.997 p/ 10 primeiros

**Trecho literal:**

> "resina não é fim, resina é meio. Resina é meio para você cuida da família, você ter tempo livre com a sua esposa, precisa ter tempo livre com a sua filha, com seus filhos […] comprar essa frase para mim: a resina para você não é mais fina, ela é - escreve para mim aqui no chat - meio. É isso aí, ela é meio, ela é meio precisa alcançar outras coisas. Faz sentido galera?"

> "a imensa maioria das falhas da resina estão associadas ao operador e não o material"

> "eu falo que isso é tipo andar num campo minado […] para você andar num campo minado, […] tinha as minas mas ele não sabia onde estava na mina, mas uma coisa ele sabia: que em algum lugar já tinha uma pegada. Alguém já pisou naquele ponto e não tem nenhum um sinal de explosão aqui, não tem nenhuma pessoa caída aqui no chão porque pisou no ponto errado. Então naquele lugar aonde existe a pegada é lá que eu vou. […] eu quero te dar os locais aonde existem as pegadas"

> "o que eu vou te entregar de estética em resina e eu te entregaria em cerâmica. A nossa decisão de resina cerâmica é baseado em outras coisas"

> "evoluir e resina composta é uma coisa que eu vou te dar o passo a passo, eu vou te dar as ferramentas, eu vou te entregar qual é a trilha que você vai ter que seguir para chegar lá naquele resultado. […] você não precisa errar o quanto eu errei, você não precisa sofrer com coisas que eu já sofri"

**O que ele fez:** (1) Big Idea em frase-mantra de 6 palavras ("resina não é fim, é meio" - frase do webinar C) com micro-compromisso imediato (a sala DIGITA "meio" no chat - o espectador escreve a crença com as próprias mãos); (2) Big Domino técnico: deslocar a falha do material para o operador - se isso é verdade, toda objeção "resina pigmenta/mancha/é inferior" cai de uma vez; (3) mecanismo da nova oportunidade em metáfora visual (campo minado/pegadas = o método como atalho seguro já testado); (4) promessa de paridade com cerâmica como prova a ser entregue ao longo da aula (e entregue depois, no caso do sorriso misto); (5) reposicionamento do produto: não vende odontologia, vende liberdade - preparando o preço.

**Por que funciona:** uma única crença ("a falha é do operador, e existe trilha pronta") derruba simultaneamente a objeção técnica (material ruim), a geográfica (minha região não paga) e a de identidade (eu não levo jeito). E ditar a frase para o chat transforma declaração em compromisso público: quem digitou "meio" assinou a tese. A metáfora plantada aqui (pegadas) é cobrada uma hora depois na transição ("pisar nas minhas pegadas") - o bloco 05 vira o pedágio do bloco 08.

**O que é decalcável vs do nicho:** decalcável: frase-mantra ditada ao chat + falha deslocada do instrumento para o operador + metáfora-mecanismo que retorna no pitch. Do nicho: resina/cerâmica/consultório - e a frase "resina é meio" é deste webinar, não da marca; no Soft a frase-mantra tem que sair do vocabulário do especialista.

---

### GAIA2k - "Gestão Ágil na Era da IA" (Denison Vieira / a escola de gestão) - Formação GA 2.0 a R$1.997 à vista / 12x R$199; edição que troca a onda VUCA pela onda IA

**Trecho literal:**

A declaração + promessa de prova:

> "Na era da IA, o gestor do futuro é um gestor ágil. Já deve ter ouvido isso em algum lugar? Pelo menos de mim, com certeza você já ouviu, tá? Mas eu vou explicar para você o porquê. Porquê dessa afirmação? […] Mas na era da IA, a gestão hágia mais necessária do que nunca. Eu vou te explicar porquê."

O dominó central (a crença única que derruba tudo):

> "a IA não é uma ameaça, tá? Mas ela é uma oportunidade pra você que é líder e gestor. Que oportunidade? Aí, ela automatiza tudo. Menos cuidar de pessoas. Por isso que a gestão e a liderança não vão acabar. Fica tranquilo, tá?"

> "O profissional de liderança que se atualizar vai ser indispensável. Por quê? Justamente por isso. Porque a IA não consegue motivar uma equipe. A IA não consegue mediar conflitos entre as pessoas, as pessoas não confiam na IA para esse tipo de coisa. Ela precisa de outro ser humano ali."

O reframe da IA (nova oportunidade, não ameaça):

> "Enxergue a IA apenas como uma extensão cognitiva, ela é uma extensão do seu cérebro. Eu gosto de brincar que a IA é só uma calculadora para o cérebro. […] A calculadora substituiu o contador? A calculadora substituiu o matemático? Não. Ela só potencializou. É isso. A IA é isso. Ela é uma calculadora, só que ela é um pouco mais inteligente que a calculadora, né?"

A consequência prática (o que te sobra - e vale mais):

> "Desenvolve o teu lado humano, esse é o teu grande triunfo, tá? Isso é o que a IA nunca vai substituir de você. O gestor, mais humano. Porque é isso que vai cada vez mais ser demandado."
...
**Por que funciona:** se o espectador aceita "a IA automatiza tudo, menos cuidar de pessoas", o resto cai sozinho: gestão+liderança vira a única profissão blindada, e quem vende formação nisso vende o seguro contra o meteoro. ACHADO da análise a escola de gestão (exemplos-vivos): comparando com as edições VUCA, esta edição prova que a big idea bem construída tem um "slot de onda" trocável - VUCA saiu, IA entrou, e a equação pessoal + o mecanismo (a "visão de floresta", da escola de gestão) ficaram intactos; o ticket até subiu (R$3.000→3.500 de tabela). O que envelhece é a onda, nunca a equação.
...
> "Now, before we dive in, I have a quick question for you. Why do webinars work so well? What about them makes them so tremendously effective? […] Well, here's why. They're the second most powerful medium for education. only surpassed by in-person nose ton-nose toes toes interaction. But the beauty of this is you don't have to leave your room. I didn't leave my house. I did the 50ft commute."

> "Here's an even more important reason why webinars work so well. They cater to the 20% of the market that represents 80% of the buying power. Every single market, this is a mathematical fact. This is the 8020 rule if you've ever heard of that."

A crença única (serve→sell):

> "And here's something that I've used in my business that has served me well and I'll pass it on to you here is the more you serve, the more you can sell. People don't mind if you're selling them as long as you're also serving them."

A promessa de sistematização (remove o "eu não consigo"):

> "How do I distill 20,000 plus hours and the total sum of my knowledge into something that you can immediately put into action and have a bottom line impact the first time that you use it? Well, here's how. We are just going to break down the formula, make it systematic, and then we remove any uncertainty or any doubt. It's kind of one of those things. Follow the formula, get the result right."

> "I am fully confident you could give me anybody off the streets with the smallest amount of desire to get wealthy. We could put them in front of this, give them some technique, and they could go out there and do it just as good as pretty much anybody because it's a system that I've developed over the last eight years."

O breakthrough que resolve o dilema (aula boa não vende × pitchfest vende e destrói):

> "I said, \"What would it take to give the most valuable possible to my audience the most value so that person would leave the webinar better off than they were before they first showed up? And if and only if it makes sense to them to show how investing in your offer would provide even more value than what they're already experienced. So essentially, it's this. You make them better and then you show them that it can get even better still if they say yes to your offer at the end. That's the breakthrough."

E o dominó contraintuitivo:
...
**O que é decalcável vs do nicho:** decalcável: tese como resposta a um dilema sem saída pelos caminhos conhecidos; aforismo-crença; sistema à prova de pessoa; inversão contraintuitiva com lastro numérico. Do nicho: webinars/closes/80/20 do buying power.
...
> "What's going to turn your life around is when you make your first dollar selling information products using the very specific formula we're going to discuss here today. And it's the formula that I stumbled into more than discovered when I made my first dollar, which was in November 12, 2007. And to this very day, I still follow this model and this formula millions upon millions of dollars later. Would you like to know what that formula is? Okay, write this down. This is very important to your financial future. Here is the formula. One problem, one solution, one sitting product creation. Simple formula, but there's more here than meets the eye. We're going to have to dig a little bit into this. Otherwise, you might just discount it and say, \"That doesn't seem magical.\" There is magic here, my friend. I promise you in the formula."

O dominó declarado como lei:

> "Here is the conclusion of all conclusions. When starting out, if there is any break between the start and the finish of your information product, you are probably doomed to fail. Whoa. That is powerful, powerful stuff. And I know a lot of people don't agree with that. Um, but then we watch them in the marketplace and they struggle months then years and they don't tap into this model. But if you do follow this process when starting out, your chance of success is astronomical."

> "So here is the solution. The product creation process starts when you sit down and begin working on that product. And the product is finished when you get up. No if ends or buts. This is an inflexible rule of engagement, right? You say, Jason, what if I got to go to the bathroom? You have two options. So option number one, hold it, or option number two, hurry up and finish the product."

O conceito-âncora "inevitable success" (vem de um aluno):
...
**O que é decalcável vs do nicho:** decalcável: dominó em causa única e contraintuitiva; regra inflexível com humor que a fixa; reframe sem cenário de derrota; crença batizada com nome de aluno. Do nicho: infoproduto/uma sentada/first dollar.
...
4. **Culpa externalizada.** Aceitar a crença nunca exige o avatar admitir incompetência: o mundo mudou (VUCA/IA - a escola de gestão), te venderam "dieta burra" (Vítor Abrão), a falha é do operador não-treinado e existe trilha (webinar C), o problema é a interrupção, não você (Fladlien), "eles nunca te contaram como" (Pupim).
...
7. **Janela de oportunidade quantificada com hedging honesto.** "Eu chutaria, não tenho esse dado preciso… mas 80% com certeza" (a escola de gestão); "nem 10% têm a licença" (Pupim); "148 times" (Fladlien). A ressalva declarada aumenta a credibilidade do número.
...
9. **Fecho em equação causal simples, dita em voz alta.** "A equação é simples: você resolvendo os problemas das empresas → empresa lucra + você é valorizado" (a escola de gestão); "adesão → resultado mantido" (MDI); "uma sentada → produto pronto → primeiro dólar" (Fladlien).
10. **Reframe identitário embutido.** O lead sai de "quem sofre o problema" para "quem resolve problemas" / "gestor do futuro" (a escola de gestão) / faixa preta (webinar C) / quem dá "permission to succeed" a si (Fladlien).
11. **Slot de onda trocável (achado da análise da escola de gestão).** Entre as edições VUCA e a edição IA (GAIA2k), trocou-se a onda e manteve-se equação pessoal + mecanismo - escrever o bloco já sabendo qual pedaço é "onda" (vai envelhecer) e qual é "equação" (não pode mudar).
