...
**O que é decalcável vs do nicho:** decalcável: a arquitetura inteira (escassez de bônus + cartão na mão + confirmação de sistema + corrida narrada). Do nicho: nada aqui é de nicho - é a peça mais transplantável da máquina; o que muda é o conteúdo dos bônus.

---

### 5 Níveis de Planejamento (Denison/a escola de gestão) - mesma máquina; o chat como placar de vendas

**Trecho literal:**

> "Enquanto eu estou abrindo aqui, já vai pegando o seu cartão. Se é aplicativo, se é cartão virtual, já vai abrindo no celular para você conseguir ficar entre os 15 primeiros."

> (gamificação da corrida) "Quando você clicar no link que eu liberar agora, vai aparecer uma mensagem para você ali. Parabéns, você está entre os 15 primeiros."
...
### Gestão Ágil ed. 2.0 (a escola de gestão) - contagem regressiva narrada + desconto por canal
...
**O que é decalcável vs do nicho:** decalcável: contagem narrada, desconto por canal (o link do webinar como dono do último degrau), rede de segurança pós-corrida. Do nicho: nada.

---

### GAIA2k (Denison/a escola de gestão) - a narração de vagas mais longa do corpus + empurrão moral final

**Trecho literal:**

> "Já vai separando o cartão? Pega aí o seu cartão, já fica no jeito para você não reclamar e falar: Ah, Denison, não deu tempo de me inscrever."
...
**O que é decalcável vs do nicho:** decalcável: narração de contagem, urgência de preço com lastro auditável, encerrar o webinar literalmente dentro da corrida. Do nicho: nada.

---

### Aluna 80k (Juliana Pupim) - deadline de relógio + pico emocional DEPOIS do preço
...
> (fechamento emocional 1 - frase do mentor, com crédito ao Wendel Carvalho) "Você é a pessoa que vai falar pro seu filho: \"Faz porque eu fiz\" ou você vai ser a pessoa que vai falar: \"Faz porque eu não fiz?\" […] Cara, isso, isso me, ó, tô arrepiada, gente."

> (fechamento emocional 2 - a história da mãe, chorando ao vivo) "E a minha mãe me criou para falando assim: \"Filha, não seja essa pessoa, sabe? Seja independente […] porque é muito ruim depender do marido."

> (custo da inação invertido) "Nada é fácil, mas é fácil ficar no Brasil e ganhar pouco. É fácil passar dificuldade, é fácil todo mês."
...
**O que é decalcável vs do nicho:** decalcável: pico emocional pós-preço, custo da inação como "o fácil que sai caro", CTA relacional. Do nicho: a cena mãe/filho e o frame Brasil-vs-exterior; o choro não se fabrica - só usar emoção real.

---

### Webinar o dono A (pele Soft: nutrição / Vítor Abrão / MDI) - urgência de SESSÃO, o desenho canônico pra perpétuo
...
> (FOMO social) "você vai conseguir ver resultados lindos todos os dias, todos os dias, se você não vier comigo, mas vai ser só pelo Instagram, eles nunca vão ser os seus […] a escolha é sua: ficar na arquibancada vendo tudo isso acontecer sabendo que você poderia ter entrado nesse barco e não entrou"
...
**O que é decalcável vs do nicho:** decalcável: o desenho inteiro é o gabarito de escassez pra webinar perpétuo (condição de sessão + diferença de preço real + presente no checkout). Do nicho/dono: o barco/arquibancada e o tom "bicho" são da pele Vítor.

---

### Webinar C (corpus o dono - voz Bruno, dentista) - 10 vagas de PREÇO com contagem ao vivo até a última frase
...
> (recusa pública de extensão) "Galera: abro meu, eu quero fazer amanhã, mantenha esse preço - desculpa, infelizmente não"
...
> (última frase do webinar) "tá uma vaga ainda, Bruno, nos 10, última vaga dos dez, não perde, que esse preço é só para agora tá. Tamo junto galera, forte abraço para vocês"
...
**O que é decalcável vs do nicho:** decalcável: recusa pública de extensão, takeaway no fecho, jamais deixar silêncio com o carrinho aberto. Do nicho: nada - mecânica pura.

---

### Fladlien #1 (One to Many) - escassez mecânica terceirizada: o timer que decide sozinho

**Trecho literal:**

> "When you go to that page and that countdown timer hits zero, it's rigged up. So, it automatically closes the deal and then forwards it to this page. We do not make this available very often for a very specific reason why I want to make sure that I am deliberate on when people are joining this program so we can make sure we serve them with the best amount of help as possible."

> "when that countdown timer on that page hits zero, then it's gone for you. Gone forever. […] when it comes back online and I don't know when that'll be sometimes there's many many months in between"

> (custo duplo da inação) "every single day that you're not using this is a day that not it cost you twice. the first way it cost you is you don't make any money that you deserve to make. the second way it cost you is somebody else is using it and they're winning and they're surging ahead and you're not"

> (CTA narrado clique a clique) "You're going to find one of these green buttons that says register here. You're going to click on it or tap on it depending on whatever device you're on. […] fill out the form and now immediately get transferred into the members area"

> (despedida de identidade) "My name is Jason Flatlin. I appreciate you, and I know you deserve to be wealthy. Let me help you do it."

**O que ele fez:** escassez mecânica e impessoal ("it's rigged up… automatically closes" - a máquina decide, não o vendedor) com reason-why de serviço; incerteza de retorno ("não sei quando volta… às vezes muitos meses"); custo da inação bifurcado (perda direta + perda relativa pro concorrente); CTA com fricção zero, narrando cada clique até a área de membros; despedida que afirma identidade em vez de implorar a venda.

**Por que funciona:** a urgência é crível porque é terceirizada pra um mecanismo com justificativa operacional - remove o cheiro de pressão de vendedor. E narrar o caminho do clique elimina a última fricção: a pessoa já fez a compra mentalmente antes de tocar no botão.

**O que é decalcável vs do nicho:** decalcável: terceirizar a escassez pra um mecanismo com reason-why, narrar o caminho do clique, o custo duplo da inação. Do nicho: nada.

---

### Fladlien #2 (Product E-Class) - o timer como assassino do "maybe"

**Trecho literal:**

> "Here's what you have to do though. You must go now and you must go fast before this offer expires."

> (bônus pra fast action takers, amarrado aos cases) "Not everyone's going to get this special pricing. And definitely not everyone's going to get these exclusive bonuses. They are reserved only for fast action takers. The people like the J Boyers, like the Mandy Kindles, like the Kostas Pepists that you saw here earlier."

> (o reframe do maybe) "But if you stay a maybe, then the decision will be made for you when the timer hits zero on that page. And I don't know about you, but I don't like decisions being made for me, especially about my success and my financial future. […] When that timer hits zero, you automatically go from a maybe to a no."

> (CTA com calendário concreto) "It is Thursday, midafter afternoon, Los Angeles time. […] You can watch the first video tonight. […] create it on Saturday, put it for sale on Sunday, and have your first sale on Monday. How sweet would that be?"

> (URL como refrão) "producteclass.com/special" - repetida ao menos 3x.

**O que ele fez:** (1) escassez de pricing + bônus para "fast action takers", justificada por identidade ("o tipo de gente em quem aposto") e ligada aos heróis dos cases; (2) timer com consequência automática REFRAMADO: "maybe vira no sozinho" - urgência como proteção da autonomia do lead; (3) reason-why da exclusividade (você assistiu, você agiu); (4) CTA com cronograma dia-a-dia até a primeira venda na segunda-feira - a compra vira plano; (5) repetição da URL como âncora sonora.

**Por que funciona:** a urgência não é gritada, é racionalizada: o timer existe para matar o estado "maybe" - que o próprio webinar já demonizou. O lead corre não por medo de perder o desconto, mas para não deixar "outro decidir por ele".

**O que é decalcável vs do nicho:** decalcável: o reframe "timer protege sua autonomia", o cronograma concreto pós-compra, amarrar o bônus de velocidade à identidade dos cases. Do nicho: o calendário até a primeira venda - a unidade muda por nicho.

---

## Padrões transversais (checklist - o que TODOS fazem neste bloco)

- [ ] **Escassez crível e auditável, nunca sobre mentira.** Três desenhos validados: bônus pros N primeiros (produto não fecha - a escola de gestão), condição/preço da sessão (comprável depois por mais caro - o dono A/C, Juliana), mecanismo terceirizado com reason-why (timer - Fladlien). Nenhum campeão mente estoque.
...
- **Urgência por gritaria, sem reason-why.** O Fladlien racionaliza ("matar o maybe"), a escola de gestão mecaniza (sistema), a Juliana emociona (identidade) - nenhum simplesmente grita "CORRE!" sem estrutura por baixo.
- **Empilhar escassez e desconto na mesma moeda.** A máquina da escola de gestão separa: o desconto remove a objeção de preço (todos levam), a corrida é pelos bônus (15 primeiros). Misturar dilui as duas urgências.
- **Pro perpétuo: deadline de calendário fake.** O desenho validado é o do dono A - condição da SESSÃO com diferença de preço real e auditável. Timer de calendário falso em evergreen é o erro que queima a máquina.
- **Decalcar forma com dono** ("rigged timer" e o frame do maybe são Fladlien; "parabéns, você está entre os 15" é da escola de gestão; barco/arquibancada é pele Vítor). Extrair o desenho, reconstruir na voz do especialista.
...
- **Perpétuo** (o dono A): condição da sessão ("se essa aula acabar, acabou") + diferença de preço real - o único desenho honesto pra loop.
- **Ao vivo, vagas de preço** (o dono C): 10 unidades no preço com contagem até a última frase.
