...
async function validateToken(token) {
  ...
  try {
    init = await postJson(MCP_URL, {
      ...
      params: { protocolVersion: "2025-06-18", capabilities: {}, clientInfo: { name: "Agente", version: "1.0" } },
    }, auth);
...
const CONNECT_VERB = "(?:conect(?:ar|a|e|o|ei|amos)|lig(?:ar|a|ue|o|uei)|vincul(?:ar|a|e|o)|plug(?:ar|a|o)|integr(?:ar|a|e|o))";
