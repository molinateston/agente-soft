...
## ETAPA 2 — Atualizar (snapshot + baixar versão nova + validar)
Rode o script — ele faz tudo com segurança (backup do não-secreto, baixa a versão
publicada da ponte, revalida, reinicia e valida ponta a ponta):
```bash
